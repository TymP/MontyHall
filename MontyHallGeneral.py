...
print('Probability of win given choice change: ',PwinGchange)
print('Probability of win given same choice: ',PwinGstay)
if(PwinGchange<=PwinGstay):
    shouldChange=False
    print("Conclusion: For Monty Hall with ", NUMBER_OF_DOORS, " doors, you SHOULD NOT change your mind.")
else:
    print("Conclusion: For Monty Hall with ", NUMBER_OF_DOORS, " doors, you SHOULD change your mind.")
