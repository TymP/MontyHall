...
doorNumbers = [3,4,5,6,7,8,9,10,11]
result = []

for number in doorNumbers:
    result.append(montyHallFn(number))

for i in range(0,len(doorNumbers)):
    print('For ', doorNumbers[i], ' doors, change = ', result[i])
